...
@gw.entity.EntityName(value = "Argo_DiverValues")
public class Argo_DiverValues extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.Argo_DiverValues, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.Argo_DiverValues, entity.PolicyPeriod>("entity.Argo_DiverValues");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DRIVERCELLPHONE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DriverCellPhone");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DRIVEROVERRIDE_T_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DriverOverride_T");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DRIVERSCOREVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DriverScoreValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DRIVERSTARTDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DriverStartDate");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> USEDCARMILEAGE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UsedCarMileage");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.Argo_DiverValuesInternal _internal;
   ...
   */
  public Argo_DiverValues(entity.PolicyPeriod branch)  {
   ...
   */
  public Argo_DiverValues(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected Argo_DiverValues(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.Argo_DiverValuesInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.Argo_DiverValuesInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.Argo_DiverValues clone() {
    return (entity.Argo_DiverValues)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.Argo_DiverValues getBasedOn() {
    return (entity.Argo_DiverValues)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.Argo_DiverValues getBasedOnValue() {
    return (entity.Argo_DiverValues)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.String getDriverCellPhone() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DRIVERCELLPHONE_PROP.get());
  }
  ...
  public java.util.Date getDriverScoreValue() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DRIVERSCOREVALUE_PROP.get());
  }
  ...
  public java.util.Date getDriverStartDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DRIVERSTARTDATE_PROP.get());
  }
  ...
  public entity.Argo_DiverValues getFixed() {
    return (entity.Argo_DiverValues)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.Argo_DiverValues getSlice(java.util.Date sliceDate) {
    return (entity.Argo_DiverValues)getSliceUntyped(sliceDate);
  }
  ...
  public entity.Argo_DiverValues getUnsliced() {
    return (entity.Argo_DiverValues)getUnslicedUntyped();
  }
  ...
  public java.lang.Integer getUsedCarMileage() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(USEDCARMILEAGE_PROP.get());
  }
  
  public entity.windowed.Argo_DiverValuesVersionList getVersionList() {
    return (entity.windowed.Argo_DiverValuesVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isDriverOverride_T() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DRIVEROVERRIDE_T_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.Argo_DiverValues value) {
  ...
  public void setDriverCellPhone(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DRIVERCELLPHONE_PROP.get(), value);
  }
  ...
  public void setDriverOverride_T(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DRIVEROVERRIDE_T_PROP.get(), value);
  }
  ...
  public void setDriverScoreValue(java.util.Date value) {
    __getInternalInterface().setFieldValue(DRIVERSCOREVALUE_PROP.get(), value);
  }
  ...
  public void setDriverStartDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(DRIVERSTARTDATE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.Argo_DiverValues value) {
  ...
  public void setUsedCarMileage(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(USEDCARMILEAGE_PROP.get(), value);
  }
  
  public entity.Argo_DiverValues split(java.util.Date splitDate) {
    return (entity.Argo_DiverValues)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.Argo_DiverValuesInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Argo_DiverValues.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Argo_DiverValues.class, config);
    com.guidewire._generated.entity.Argo_DiverValuesInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Argo_DiverValues, com.guidewire._generated.entity.Argo_DiverValuesInternal>() {
      public java.lang.Object getImplementation(entity.Argo_DiverValues bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.Argo_DiverValuesInternal getInternalInterface(entity.Argo_DiverValues bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Argo_DiverValues newEmptyInstance() {
        return new entity.Argo_DiverValues((java.lang.Void)null);
      }
