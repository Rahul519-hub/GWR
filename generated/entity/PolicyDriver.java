...
public class PolicyDriver extends entity.PAPolicyContactRole implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.AccountSyncable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> ARGO_DIVERVALUES_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Argo_DiverValues");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DRIVERINFORMATION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DriverInformation");
  ...
  /**
   * Gets the value of the Argo_DiverValues field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Argo_DiverValues getArgo_DiverValues() {
    return (entity.Argo_DiverValues)__getInternalInterface().getFieldValue(ARGO_DIVERVALUES_PROP.get());
  }
  ...
  /**
   * Gets the value of the DriverInformation field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isDriverInformation() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DRIVERINFORMATION_PROP.get());
  }
  ...
  /**
   * Sets the value of the Argo_DiverValues field.
   */
  public void setArgo_DiverValues(entity.Argo_DiverValues value) {
    __getInternalInterface().setFieldValue(ARGO_DIVERVALUES_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the DriverInformation field.
   */
  public void setDriverInformation(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DRIVERINFORMATION_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyDriverInternal {
    ...
    public gw.pl.persistence.core.Key getArgo_DiverValuesID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(ARGO_DIVERVALUES_PROP.get());
    }
    ...
    public void setArgo_DiverValuesID(gw.pl.persistence.core.Key value) {
      setFieldValue(ARGO_DIVERVALUES_PROP.get(), value);
    }
