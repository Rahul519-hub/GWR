...
public class PolicyPeriod extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDatedBranch, entity.RootInfo, entity.FrozenSetMember, entity.AnswerContainer, entity.DestructionRootPinnable, entity.EventAware, com.guidewire.pc.domain.note.NoteContainer, com.guidewire.pc.domain.personaldata.PinnableDomainMethods, gw.api.contingency.ContingencyCreator, gw.api.domain.DenormalizedFKOutOfDomainGraph, gw.api.domain.document.DocumentContainer, gw.api.history.CustomHistory, gw.api.reinsurance.ReinsurableCoverable {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> ARM_INSURANCE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Arm_Insurance");
  ...
  public entity.Arm_Insurance getArm_Insurance() {
    return (entity.Arm_Insurance)__getInternalInterface().getFieldValue(ARM_INSURANCE_PROP.get());
  }
  ...
  public void setArm_Insurance(entity.Arm_Insurance value) {
    __getInternalInterface().setFieldValue(ARM_INSURANCE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyPeriodInternal {
    ...
    public gw.pl.persistence.core.Key getArm_InsuranceID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(ARM_INSURANCE_PROP.get());
    }
    ...
    public void setArm_InsuranceID(gw.pl.persistence.core.Key value) {
      setFieldValue(ARM_INSURANCE_PROP.get(), value);
    }
