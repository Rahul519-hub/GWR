...
class LineWizardStepSet_PersonalAutoExpressions {
  ...
  public static class LineWizardStepSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'screen' attribute on JobWizardStep (id=Argo_Insurance) at LineWizardStepSet.PersonalAuto.pcf: line 46, column 43
    function screen_onEnter_17 (def :  pcf.Argo_InsuranceScreen) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'screen' attribute on JobWizardStep (id=Arm_Insurance) at LineWizardStepSet.PersonalAuto.pcf: line 50, column 42
    function screen_onEnter_19 (def :  pcf.Arm_Insurance_Screen) : void {
      def.onEnter(policyPeriod)
    }
    ...
    // 'screen' attribute on JobWizardStep (id=Argo_Insurance) at LineWizardStepSet.PersonalAuto.pcf: line 46, column 43
    function screen_refreshVariables_18 (def :  pcf.Argo_InsuranceScreen) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'screen' attribute on JobWizardStep (id=Arm_Insurance) at LineWizardStepSet.PersonalAuto.pcf: line 50, column 42
    function screen_refreshVariables_20 (def :  pcf.Arm_Insurance_Screen) : void {
      def.refreshVariables(policyPeriod)
    }
