...
class DesktopExpressions {
  ...
  public static class DesktopExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=Desktop) at Desktop.pcf: line 47, column 39
    ...
    static function firstVisitableChildDestinationMethod_22 () : pcf.api.Destination {
      ...
      dest = pcf.Argo_Insurancepge.createDestination()
      if (dest.canVisitSelf()) {
        return dest
      }
      return null
    ...
    function menuActions_onEnter_18 (def :  pcf.DesktopMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=Desktop) at Desktop.pcf: line 9, column 73
    function menuActions_refreshVariables_19 (def :  pcf.DesktopMenuActions) : void {
