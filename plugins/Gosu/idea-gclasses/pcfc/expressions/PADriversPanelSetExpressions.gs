...
class PADriversPanelSetExpressions {
  ...
  public static class DriverDetailsCVExpressionsImpl extends DriversListDetailPanelExpressionsImpl {
    ...
    // 'def' attribute on PanelRef (id=Argo_DiverPanelRefID) at PADriversPanelSet.pcf: line 197, column 40
    function def_onEnter_75 (def :  pcf.Argo_DiverPanelSet) : void {
      def.onEnter(selectedDriver,paLine,openForEdit)
    }
    ...
    // 'def' attribute on PanelRef (id=Argo_DiverPanelRefID) at PADriversPanelSet.pcf: line 197, column 40
    function def_refreshVariables_76 (def :  pcf.Argo_DiverPanelSet) : void {
      def.refreshVariables(selectedDriver,paLine,openForEdit)
    }
