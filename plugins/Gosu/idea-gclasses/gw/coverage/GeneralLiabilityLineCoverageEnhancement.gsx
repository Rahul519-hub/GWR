...
enhancement GeneralLiabilityLineCoverageEnhancement : entity.GeneralLiabilityLine {
  ...
  property get MedicalCoverages_EXT () : productmodel.MedicalCoverages_EXT {
    return (gw.api.productmodel.ClausePatternLookup.getByPublicID("zh5h6g18f8srl14n0dpdjn32icb") as com.guidewire.pc.api.productmodel.ClausePatternInternal).getClause(this) as productmodel.MedicalCoverages_EXT
  }
  
  property get MedicalCoverages_EXTExists () : boolean {
    return (gw.api.productmodel.ClausePatternLookup.getByPublicID("zh5h6g18f8srl14n0dpdjn32icb") as com.guidewire.pc.api.productmodel.ClausePatternInternal).hasClause(this)
  }
